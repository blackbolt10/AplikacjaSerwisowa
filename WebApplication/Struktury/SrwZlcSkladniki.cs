...
{    public class SrwZlcSkladniki
    {
        ...
        public SrwZlcSkladniki(Int32 _szs_Id, Int32 _szs_sznId, Int32 _szs_Pozycja, Int32 _szs_TwrNumer, Int32 _szs_TwrTyp, Int32 _SZS_Synchronizacja, Double _szs_Ilosc, String _Twr_Jm, String _szs_TwrNazwa, String _Twr_Kod)
        {
            szs_Id = _szs_Id;
            ...
            SZS_Synchronizacja = _SZS_Synchronizacja;
