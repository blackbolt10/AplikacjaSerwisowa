...
namespace WebApplication
{
    public class KntKarty
    {
        ...
        public KntKarty(Int32 _Knt_GIDNumer, String _Knt_Akronim, String _Knt_nazwa1, String _Knt_nazwa2, String _Knt_nazwa3, String _Knt_KodP, String _Knt_miasto, String _Knt_ulica, String _Knt_Adres, String _Knt_nip, String _Knt_telefon1, String _Knt_telefon2, String _Knt_telex, String _Knt_fax, String _Knt_email, String _Knt_url, Int32 _Knt_Archiwalny, Int32 _Knt_ToDo)
        {
            ...
            Knt_url = _Knt_url;
            Knt_Archiwalny = _Knt_Archiwalny;
            Knt_ToDo = _Knt_ToDo;
        }
