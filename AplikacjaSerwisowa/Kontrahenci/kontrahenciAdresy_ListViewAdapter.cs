...
namespace AplikacjaSerwisowa
{
    class kontrahenciAdresy_ListViewAdapter : BaseAdapter<string>
    {
        ...
        public kontrahenciAdresy_ListViewAdapter(Context context, List<string> kontrahenci_List, List<string> data_List, List<string> adres_List, List<string> telefon_List, List<string> godzina_List, List<string> wykonanie_List)
        {
