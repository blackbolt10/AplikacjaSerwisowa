...
namespace WebApplication
{
    class SrwZlcNag
    {
        ...
        public int SZN_ToDo { get; set; }


        public SrwZlcNag(int _SZN_Id, int _SZN_Synchronizacja, int _SZN_KntTyp, int _SZN_KntNumer, int _SZN_KnATyp, int _SZN_KnANumer, String _SZN_Dokument, String _SZN_DataWystawienia, String _SZN_DataRozpoczecia, String _SZN_Stan, String _SZN_Status, String _SZN_Opis, int _SZN_ToDo)
        {
            this.SZN_Id = _SZN_Id;
